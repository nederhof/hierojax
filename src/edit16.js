...
class LostNode extends Node {
	...
	setEditing() {
		...
		$('lost11').checked = this.group.width == 0.25 && this.group.height == 0.25;
		$('lost21').checked = this.group.width == 0.5 && this.group.height == 0.25;
		$('lost31').checked = this.group.width == 0.75 && this.group.height == 0.25;
		$('lost41').checked = this.group.width == 1 && this.group.height == 0.25;
		$('lost12').checked = this.group.width == 0.25 && this.group.height == 0.50;
		$('lost32').checked = this.group.width == 0.75 && this.group.height == 0.50;
		$('lost13').checked = this.group.width == 0.25 && this.group.height == 0.75;
		$('lost23').checked = this.group.width == 0.5 && this.group.height == 0.75;
		$('lost33').checked = this.group.width == 0.75 && this.group.height == 0.75;
		$('lost43').checked = this.group.width == 1 && this.group.height == 0.75;
		$('lost14').checked = this.group.width == 0.25 && this.group.height == 1;
		$('lost34').checked = this.group.width == 0.75 && this.group.height == 1;
...
class Edit {
	...
	static makeFromString(string, address) {
		try {
			var fragment = syntax16.parse(string);
			var error = '';
		} catch(err) {
			var fragment = syntax16.parse('');
	...
	static adjustLostSize(s) {
		...
		switch (s) {
			...
			case '11':
				tree.focus.group.width = 0.25; tree.focus.group.height = 0.25; break;
			case '21':
				tree.focus.group.width = 0.5; tree.focus.group.height = 0.25; break;
			case '31':
				tree.focus.group.width = 0.75; tree.focus.group.height = 0.25; break;
			case '41':
				tree.focus.group.width = 1; tree.focus.group.height = 0.25; break;
			case '12':
				tree.focus.group.width = 0.25; tree.focus.group.height = 0.50; break;
			case '32':
				tree.focus.group.width = 0.75; tree.focus.group.height = 0.50; break;
			case '13':
				tree.focus.group.width = 0.25; tree.focus.group.height = 0.75; break;
			case '23':
				tree.focus.group.width = 0.5; tree.focus.group.height = 0.75; break;
			case '33':
				tree.focus.group.width = 0.75; tree.focus.group.height = 0.75; break;
			case '43':
				tree.focus.group.width = 1; tree.focus.group.height = 0.75; break;
			case '14':
				tree.focus.group.width = 0.25; tree.focus.group.height = 1; break;
			case '34':
				tree.focus.group.width = 0.75; tree.focus.group.height = 1; break;
			default:
