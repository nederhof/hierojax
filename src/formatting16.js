...
Group.LOST14 = '\u{13459}';
Group.LOST21 = '\u{1345A}';
Group.LOST23 = '\u{1345B}';
Group.LOST31 = '\u{1345C}';
Group.LOST32 = '\u{1345D}';
Group.LOST33 = '\u{1345E}';
Group.LOST34 = '\u{1345F}';
Group.LOST41 = '\u{13460}';
Group.LOST43 = '\u{13461}';
...
class Lost extends Group {
	...
	toString() {
		...
		else if (this.width == 0.25 && this.height == 0.25)
			var s = Group.LOST11;
		else if (this.width == 0.25 && this.height == 0.50)
			var s = Group.LOST12;
		else if (this.width == 0.25 && this.height == 0.75)
			var s = Group.LOST13;
		else if (this.width == 0.25 && this.height == 1)
			var s = Group.LOST14;
		else if (this.width == 0.50 && this.height == 0.25)
			var s = Group.LOST21;
		else if (this.width == 0.50 && this.height == 0.75)
			var s = Group.LOST23;
		else if (this.width == 0.75 && this.height == 0.25)
			var s = Group.LOST31;
		else if (this.width == 0.75 && this.height == 0.50)
			var s = Group.LOST32;
		else if (this.width == 0.75 && this.height == 0.75)
			var s = Group.LOST33;
		else if (this.width == 0.75 && this.height == 1)
			var s = Group.LOST34;
		else if (this.width == 1 && this.height == 0.25)
			var s = Group.LOST41;
		else if (this.width == 1 && this.height == 0.75)
			var s = Group.LOST43;
		else
