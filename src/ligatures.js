...
'\u{13B8B}': {
	...
	vertical: [ { ch: '\u{1308B}', x: 0.1, y: 0.70, w: 0.9, h: 0.2 } ] },
'\u{13141}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{1313F}', x: 0, y: 0, w: 0.9, h: 1 } ],
	vertical: [ { ch: '\u{13333}', x: 0, y: 0.1, w: 1, h: 0.7 } ] },
'\u{13157}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13153}', x: 0.05, y: 0, w: 0.9, h: 1 } ],
	vertical: [ { ch: '\u{1308B}', x: 0, y: 0.3, w: 1, h: 0.25 } ] },
'\u{13156}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13153}', x: 0.05, y: 0, w: 0.9, h: 1 } ],
	vertical: [ { ch: '\u{1309D}', x: 0, y: 0.15, w: 1, h: 0.25 } ] },
'\u{13155}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13153}', x: 0.05, y: 0, w: 0.9, h: 1 } ],
	vertical: [ { ch: '\u{1309E}', x: 0, y: 0.15, w: 1, h: 0.25 } ] },
'\u{131B2}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13153}', x: 0.05, y: 0, w: 0.85, h: 1 } ],
	vertical: [ { ch: '\u{131B1}', x: 0.1, y: 0.35, w: 0.9, h: 0.2 } ] },
'\u{13174}': {
	type: 'overlay',
...
'\uE508': {
	...
	vertical: [ { ch: '\u{1327B}', x: 0, y: 0.30, w: 1, h: 0.30 } ] },
'\u{13266}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13265}', x: 0.4, y: 0, w: 0.25, h: 1 } ],
	vertical: [ { ch: '\u{1309D}', x: 0, y: 0.2, w: 1, h: 0.35 } ] },
'\u{132A3}': {
	type: 'overlay',
...
'\u{130B9}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{132F4}', x: 0.5, y: 0, w: 0.20, h: 1 } ],
	vertical: [ { ch: '\u{130B8}', x: 0, y: 0.45, w: 1, h: 0.3 } ] },
'\u{132F5}': {
	type: 'overlay',
...
'\u{13138}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{132F4}', x: 0.4, y: 0, w: 0.25, h: 1 } ],
	vertical: [ { ch: '\u{13132}', x: 0, y: 0.3, w: 1, h: 0.35 } ] },
'\uE49A': {
	type: 'overlay',
	alt: true,
	horizontal: [ { ch: '\u{132F4}', x: 0.3, y: 0, w: 0.25, h: 1 } ],
	vertical: [ { ch: '\u{13333}', x: 0, y: 0.1, w: 1, h: 0.55 } ] },
'\u{1332D}': {
	type: 'overlay',
...
'\u{13353}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13351}', x: 0.35, y: 0, w: 0.45, h: 1 } ],
	vertical: [ { ch: '\u{133F2}', x: 0, y: 0.2, w: 1, h: 0.4 } ] },
'\u{1335A}': {
	type: 'overlay',
...
'\u{13424}': {
	type: 'overlay',
	horizontal: [ { ch: '\u{13423}', x: 0.3, y: 0, w: 0.4, h: 1 } ],
	vertical: [ { ch: '\u{1309D}', x: 0, y: 0.2, w: 1, h: 0.3 } ] },
'\u{13B88}': { 
	type: 'overlay',
