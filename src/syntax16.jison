...
/*
 * OPENING_CHAR	[\u13258|\u13259|\u1325A|\u13286|\u13288|\u13379|\u1342F]
 * CLOSING_CHAR	[\u1325B|\u1325C|\u1325D|\u13282|\u13287|\u13289|\u1337A|\u1337B]
 * DAMAGED_CHAR	[\u13447-\u13455]
...
placeholder
	...
	| LOST11 opt_vs
		{$$ = new Lost(0.25, 0.25, $opt_vs);}
	| LOST12 opt_vs
		{$$ = new Lost(0.25, 0.50, $opt_vs);}
	| LOST13 opt_vs
		{$$ = new Lost(0.25, 0.75, $opt_vs);}
	| LOST14 opt_vs
		{$$ = new Lost(0.25, 1, $opt_vs);}
	| LOST21 opt_vs
		{$$ = new Lost(0.50, 0.25, $opt_vs);}
	| LOST23 opt_vs
		{$$ = new Lost(0.50, 0.75, $opt_vs);}
	| LOST31 opt_vs
		{$$ = new Lost(0.75, 0.25, $opt_vs);}
	| LOST32 opt_vs
		{$$ = new Lost(0.75, 0.50, $opt_vs);}
	| LOST33 opt_vs
		{$$ = new Lost(0.75, 0.75, $opt_vs);}
	| LOST34 opt_vs
		{$$ = new Lost(0.75, 1, $opt_vs);}
	| LOST41 opt_vs
		{$$ = new Lost(1, 0.25, $opt_vs);}
	| LOST43 opt_vs
		{$$ = new Lost(1, 0.75, $opt_vs);}
	;
