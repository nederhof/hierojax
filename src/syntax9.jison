...
placeholder
	...
	| LOST11 opt_vs
		{$$ = new Lost(0.33, 0.33, $opt_vs);}
	| LOST12 opt_vs
		{$$ = new Lost(0.33, 0.66, $opt_vs);}
	| LOST13 opt_vs
		{$$ = new Lost(0.33, 1.00, $opt_vs);}
	| LOST21 opt_vs
		{$$ = new Lost(0.66, 0.33, $opt_vs);}
	| LOST22 opt_vs
		{$$ = new Lost(0.66, 0.66, $opt_vs);}
	| LOST23 opt_vs
		{$$ = new Lost(0.66, 1, $opt_vs);}
	| LOST31 opt_vs
		{$$ = new Lost(1, 0.33, $opt_vs);}
	| LOST32 opt_vs
		{$$ = new Lost(1, 0.66, $opt_vs);}
	;
